...
class _GameScreenState extends State<GameScreen> {
  ...
  Future<void> _loadPuzzle() async {
    final puzzle =
        await PuzzleRepository.instance.nextForDifficulty(widget.difficulty);
  ...
  Future<void> _showHintSheet() async {
    ...
    final pos = SudokuSolver.findRevealCell(board, _controller.state.puzzle.solution);
    if (pos == null) return;
    final value = SudokuSolver.revealValue(_controller.state.puzzle.solution, pos);
